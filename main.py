...
#-Coded on 18/08/21
#-Made by Splocko
#-Contributed by @R2Boyo25
#-https://github.com/Splocko
#################################################
tempWin= 'sudo bash /home/pi/Pi-Quick-Tools/Temp.sh'
import os
import gi
import time
...
class window(Gtk.Window):
    def __init__(self):
        ...
        self.addButton('Temperature', 'sudo bash /home/pi/Pi-Quick-Tools/Temp.sh', 'Temperature opened')
        self.addButton('Cpu Stats','sudo bash /home/pi/Pi-Quick-Tools/Htopstats.sh', 'Stats opened')
